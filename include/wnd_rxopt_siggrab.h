...
#ifndef WND_RXOPT_SIGGRAB_INCLUDED
	#define WND_RXOPT_SIGGRAB_INCLUDED

	#include "librtl_433.h"

	int ShowSignalGrabberDialog(rtl_433_t *rl, HWND hParent);

#endif // WND_RXOPT_SIGGRAB_INCLUDED
