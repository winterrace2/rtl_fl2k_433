...
// Unit testing
#ifdef _TEST
#define ASSERT_EQUALS(a,b) if ((a) == (b)) { ++passed; } else { ++failed; Gui_fprintf(stderr, "FAIL: %d <> %d\n", (a), (b)); }
int main(int argc, char **argv)
{
    unsigned passed = 0;
    unsigned failed = 0;

    Gui_fprintf(stderr, "optparse:: atouint32_metric\n");
    ...
    Gui_fprintf(stderr, "optparse:: atoi_time\n");
    ...
    Gui_fprintf(stderr, "optparse:: test (%u/%u) passed, (%u) failed.\n", passed, passed + failed, failed);
